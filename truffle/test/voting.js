...
/**
 * Prepares the vote session with 3 voters, 3 proposals and 3 votes
 * ProposalId = 2 is the winnerProposal
 * @param owner 
 * @param accounts 
 * @param votingInstance 
 */
...
contract("Voting - setVote", accounts => {
    ...
    it("revertes when voting for bad proposalId", async function () {
        await prepareVoteSession(accounts, this.voting, this.owner);
